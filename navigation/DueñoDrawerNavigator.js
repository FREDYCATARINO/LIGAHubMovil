...
const DueñoDrawerNavigator = () => (
  <Drawer.Navigator
    ...
    screenOptions={{
      ...
      header: ({ navigation, route }) => <DuenoBar navigation={navigation} title={route.name} />,
    }}
  >
    <Drawer.Screen
    ...
    <Drawer.Screen
      ...
      options={{
        drawerIcon: ({ color, size }) => <Ionicons name="briefcase" size={size} color={color} />, drawerItemStyle: {display: 'none'}
      }}
    />
